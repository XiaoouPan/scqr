...
axis(2, seq(0.4, 1.2, by = 0.2), line = 0, cex.axis = 1.5)
box()
abline(h = seq(0.4, 1.2, by = 0.2), v = nseq[c(2, 4, 6, 8, 10)], col = "gray", lty = 2)
#color = c("red", "blue")
#labels = c("\\texttt{censored QR}", "\\texttt{proposed method}")
#pch = c(1, 2)
#legend(7, 0.014, labels, col = color, pch = pch, lwd = 5, cex = 2, box.lwd = 1, bg = "white")
...
pch = c(1, 2)
legend("topleft", labels, col = color, pch = pch, lwd = 3, cex = 2, box.lwd = 1, bg = "white")
title(xlab = "Sample size (in thousands)", line = 2.5, cex.lab = 1.8)
